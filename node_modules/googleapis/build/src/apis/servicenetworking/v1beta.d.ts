...
export declare namespace servicenetworking_v1beta {
    ...
    class Resource$Services {
         ...
         * @return {object} Request object
         */
        patch(params?: Params$Resource$Services$Patch, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
        patch(params: Params$Resource$Services$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Services$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    interface Params$Resource$Services$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
