...
export declare namespace remotebuildexecution_v2 {
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities {
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2BatchReadBlobsRequest {
        /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2BatchReadBlobsResponse {
        /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse {
        /**
         * The raw binary data.
         */
        data?: string;
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest {
        /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequest {
        /**
         * The raw binary data.
         */
        data?: string;
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2BatchUpdateBlobsResponse {
        /**
         * The responses to the requests.
         */
     ...
     * A response corresponding to a single blob that the client tried to upload.
     */
    interface Schema$BuildBazelRemoteExecutionV2BatchUpdateBlobsResponseResponse {
        /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2CacheCapabilities {
        /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2ExecuteRequest {
        /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2ExecutionPolicy {
        /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2FindMissingBlobsRequest {
        /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2FindMissingBlobsResponse {
        /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2GetTreeResponse {
        /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2PriorityCapabilities {
        priorities?: Schema$BuildBazelRemoteExecutionV2PriorityCapabilitiesPriorityRange[];
    }
    /**
     * Supported range of priorities, including boundaries.
     */
    interface Schema$BuildBazelRemoteExecutionV2PriorityCapabilitiesPriorityRange {
        maxPriority?: number;
        minPriority?: number;
    }
    /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2ResultsCachePolicy {
        /**
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2ServerCapabilities {
        /**
         * Capabilities of the remote cache system.
         */
     ...
     */
    interface Schema$BuildBazelRemoteExecutionV2WaitExecutionRequest {
    }
    /**
     * The full version of a given tool.
     */
    interface Schema$BuildBazelSemverSemVer {
        /**
    ...
    interface Params$Resource$Actionresults$Get extends StandardParameters {
        /**
    ...
    interface Params$Resource$Actionresults$Update extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Actions$Execute extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Blobs$Batchread extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Blobs$Batchupdate extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Blobs$Findmissing extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Blobs$Gettree extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Operations$Waitexecution extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$V2$Getcapabilities extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
