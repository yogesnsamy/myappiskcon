...
export declare namespace servicecontrol_v1 {
     ...
     */
    interface Schema$ResourceLocation {
        /**
    ...
    interface Params$Resource$Services$Allocatequota extends StandardParameters {
        /**
    ...
    interface Params$Resource$Services$Check extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Report extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
