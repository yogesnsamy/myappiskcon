...
export declare namespace cloudresourcemanager_v1beta1 {
     ...
     */
    interface Schema$ListOrganizationsResponse {
        /**
    ...
    interface Params$Resource$Organizations$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Organizations$Update extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
