...
export declare namespace serviceconsumermanagement_v1 {
     ...
     * unit.
     */
    interface Schema$AddTenantProjectRequest {
        /**
     ...
     */
    interface Schema$ApplyTenantProjectConfigRequest {
        /**
     ...
     * resource.
     */
    interface Schema$AttachTenantProjectRequest {
        /**
     ...
     */
    interface Schema$BillingConfig {
        /**
     ...
     */
    interface Schema$CreateTenancyUnitRequest {
        /**
     ...
     */
    interface Schema$ListTenancyUnitsResponse {
        /**
     ...
     */
    interface Schema$PolicyBinding {
        /**
     ...
     */
    interface Schema$RemoveTenantProjectRequest {
        /**
     ...
     */
    interface Schema$SearchTenancyUnitsResponse {
        /**
         * Pagination token for large results.
         */
        nextPageToken?: string;
     ...
     */
    interface Schema$ServiceAccountConfig {
        /**
     ...
     * project removal.
     */
    interface Schema$TenantProjectConfig {
        /**
     ...
     * project.
     */
    interface Schema$TenantProjectPolicy {
        /**
     ...
     */
    interface Schema$TenantResource {
        /**
    ...
    interface Params$Resource$Services$Search extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$Addproject extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$Applyprojectconfig extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$Attachproject extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$Removeproject extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
