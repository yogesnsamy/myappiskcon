...
export declare namespace speech_v1p1beta1 {
     ...
     */
    interface Schema$LongRunningRecognizeMetadata {
        /**
     ...
     */
    interface Schema$LongRunningRecognizeResponse {
        /**
    ...
    interface Schema$SpeakerDiarizationConfig {
        /**
         * *Optional* If &#39;true&#39;, enables speaker detection for each
         * recognized word in the top alternative of the recognition result using a
    ...
    class Resource$Projects$Operations$Manualrecognitiontasks {
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Projects$Operations$Manualrecognitiontasks$Get, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
        get(params: Params$Resource$Projects$Operations$Manualrecognitiontasks$Get, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        get(params: Params$Resource$Projects$Operations$Manualrecognitiontasks$Get, callback: BodyResponseCallback<Schema$Operation>): void;
        get(callback: BodyResponseCallback<Schema$Operation>): void;
    }
    interface Params$Resource$Projects$Operations$Manualrecognitiontasks$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
